				...
				<nav className="px-4 sm:px-5 md:px-2 max-w-7xl mx-auto flex items-center gap-4">
					...
					<div className='group relative z-[2000]' tabIndex={0}>
						<button className='border rounded-full'>
							<FontAwesomeIcon icon={faUser} color="white" className="text-md text-black h-8 w-8 p-1" />
						</button>
...

							{
								isAuthenticated ? (
									<ul >
										...
										<li className=''>
											<button className='text-sm px-4 py-2 w-full rounded-md font-bold block text-black hover:bg-gray-100 hover:text-primary text-left'>
												Logout
											</button>
										</li>
